        ...
        <form nz-form [formGroup]="form" (ngSubmit)="onSubmit()">
          <nz-form-item>
            ...
            <ng-template #passwordError>
              ...
              <span *ngIf="form.get('newPassword')?.hasError('pattern')">Требования не соблюдены</span>
            </ng-template>
          </nz-form-item>
          ...
          <nz-form-item>
            ...
            <ng-template #confirmError>
              <span *ngIf="form.get('confirmPassword')?.hasError('required')">Подтвердите пароль</span>
              <span *ngIf="form.get('confirmPassword')?.hasError('passwordMismatch')">Пароли не совпадают</span>
            </ng-template>
          </nz-form-item>
